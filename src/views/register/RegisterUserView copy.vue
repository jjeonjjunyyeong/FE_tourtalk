          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control mt-2" v-model="userData.address" placeholder="상세 주소 입력">
              </div>
...
const openPostcode = () => {
  new window.daum.Postcode({
    oncomplete: function (data) {
      ...
      userData.address = data.roadAddress || data.jibunAddress;
    }
  }).open();
};
    ...
    const register = async () => {
      ...
      try {
        ...
        const response = await memberService.regist(requestData);
